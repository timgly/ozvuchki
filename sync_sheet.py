...
SHEET3_ORDER = [
    "Юргенсон", "Ван Гог", "Соломон", "Брель", "Мона Лиза",
    "Любовь", "Лавкрафт", "Магдалина", "Гойя", "Менсон",
    "Нарцисс", "Смерть", "Савонаролла", "Мунера", "Блейк",
    "Число Пи", "Вархаммер", "Бредбери", "Вивальди", "Лотрек",
    "Черная Дыра", "Кот Шредингера", "Миларепа", "Золотое Сечение",
]

SHEETS = [
    {"tab": "Короткие", "folder": BASE, "order": SHEET1_ORDER},
    {"tab": "Большие", "folder": BASE / "Большие", "order": SHEET3_ORDER},
    {"tab": "Цитаты", "folder": BASE / "Цитаты", "order": SHEET2_ORDER},
]
